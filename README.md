...
The popover is read-only configuration-wise. It shows active, window, recovery, placement, and URL state and provides Switch and Open URLs actions. Continue to use the CLI to create or edit workspaces.
